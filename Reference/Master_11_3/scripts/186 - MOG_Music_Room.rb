...
module MOG_MUSIC_ROOM
  ...
  MUSIC_INFO = {  
  "Town5" => "Title Screen Theme (by Enterbrain)",
  "Field1" => "Town Theme (by Enterbrain)",
  "Battle6" => "Battle Theme 3 (by Enterbrain)",
  "Boss_Theme" => "Boss Theme (by Freedom House)",
  "Battle_Theme" => "Battle Theme 1 (by Freedom House)",
  "Battle_Theme2" => "Battle Theme 2 (by Freedom House)",
  "Main_Theme" => "Main Theme (by Freedom House)"
  }
