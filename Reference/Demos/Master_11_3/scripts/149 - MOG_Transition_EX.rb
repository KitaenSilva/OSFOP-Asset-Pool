...
$imported[:mog_transition_ex] = true
...
module Module_Transition_EX
  ...
  def create_blackbackground
      ...
      @blackbackground.bitmap = Bitmap.new(Graphics.width,Graphics.height)
      @blackbackground.bitmap.fill_rect(0, 0, Graphics.width, Graphics.height, Color.new(0,0,0)) 
