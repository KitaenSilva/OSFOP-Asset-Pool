...
module CSCA_ENCYCLOPEDIA # Don't touch this.
  ...
  # Where id is the ID of the description youw ant to change, and description is
...
#===============================================================================
 ...
 #[:symbol,   "Text", enabled?] (don't change default category symbols)
  [:bestiary, "Bestiary", true], # Re-order these any way you want.
  [:town1,    "NPC'S"   , true], # Example for adding custom category
  [:item,     "Items"   , true], # Re-order these any way you want.
  [:weapon,   "Weapons" , true], # Re-order these any way you want.
  [:armor,    "Armors"  , true], # Re-order these any way you want.
  [:story,    "Story"   , true], # Example for adding custom category
  [:skill,    "Skills"  , true], # Re-order these any way you want.
  [:state,    "States"  , true], # Re-order these any way you want.
  ] # Do not touch.
...
#===============================================================================
  ...
  HEADER = "Encyclopedia" # Name window displayed at top during scene.
...
#===============================================================================
  ...
  DESCRIPTION[0] = [0,["This citizen lives in","Example Town."]]
  DESCRIPTION[1] = [1,["This citizen also lives","in Example Town"]]
  DESCRIPTION[2] = [2,["This is the prologue of the game"]]
  ...
  KEYS[0] = ["Citizen 1","Graphics/Encyclopedia/Test.png",DESCRIPTION[0],
  :town1,0,"Location: Test Town","Name: Citizen 1"]
  
  KEYS[1] = ["Citizen 2","Graphics/Encyclopedia/Test.png",DESCRIPTION[1],
  :town1,1,"Location: Test Town","Name: Citizen 2"]
  
  KEYS[2] = ["Prologue",nil,DESCRIPTION[2],:story,2,"",""]
  ...
  #
  # Comment out or Delete these if not using!
  CUSTOM[0] = ["NPC's",:town1,"NPC"]
  CUSTOM[1] = ["Story",:story,"information"]
#===============================================================================
end # END SETUP #
