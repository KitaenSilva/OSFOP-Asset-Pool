...
=begin
  ----------------------------------------------------------------------------
  Introduction :
  Do you want more controls in database than just copy, paste, clear, and
  multicopy?
  
  Now, with this script, you could swap the item ID from a certain database,
  inserting an empty slot or even deleting a database to rearrange the item 
  database
  
  ----------------------------------------------------------------------------
  How to use :
  Put this script below material but above main
  Set Activate to true if you want to activate this script. Then playtest.
  
  After finish editing database, save by pressing 'S', close the game and 
  reopen your editor. Then you will see the database has been changed.
  
  ----------------------------------------------------------------------------
  Terms of use :
  This script is mainly aimed just for editing database. You may edit script by 
  your own if you dare. And if you share this script in edited version, just
  don't forget to credit me as well, TheoAllen

=end
# =============================================================================
Font.default_name = ["Calibri"]       # <-- Default font
class Window_DB < Window_Selectable   # <-- Do not touch
# =============================================================================
  # --------------------------------------------------------------------------
  # Activation flag. Set to true if you want to use this script
  # --------------------------------------------------------------------------
    Activate = false
  # --------------------------------------------------------------------------
  # Database Object. Just choose one from this choice :
  # --------------------------------------------------------------------------
  # $data_actors          >> For actor database
  # $data_classes         >> For class database
  # $data_skills          >> For skill database
  # $data_items           >> For item database
  # $data_weapons         >> For weapon database
  # $data_armors          >> For armor database
  # $data_enemies         >> For enemy database
  # $data_troops          >> For troop database
  # $data_states          >> For state database
  # $data_animations      >> For animation database
  # $data_tilesets        >> For tileset database
  # $data_common_events   >> For common event database
  # 
  # Put it between "def" and "end"
  # --------------------------------------------------------------------------
  def database
    $data_common_events  # <-- here
  end
# =============================================================================
